...
$advice = [
    'Vata' => 'Favor warm, moist foods, avoid cold and dry snacks. Prefer cooked grains, milk, ghee, warming spices like ginger and cinnamon.',
    'Pitta' => 'Favor cool, refreshing foods. Eat sweet, bitter, astringent flavors. Avoid spicy, oily, fried food.',
    'Kapha' => 'Favor light, warm, spicy foods, avoid dairy, sweets, fried food. Include legumes, barley, apples.'
];
...
<head>
    ...
    <title>Diet Chart | Prakriti Analysis</title>
...
<body>
    <div class="sidebar d-flex flex-column">
        ...
        <div class="nav-main list-group list-group-flush flex-grow-1">
            ...
            <?=nav_item('Diet Chart', 'egg-fried', 'diet.php', true)?><!-- Active -->
    ...
    <div class="content-main p-4">
        <div class="bg-white p-4 rounded shadow-sm" style="max-width:650px; margin:auto;">
            <h4 class="mb-3">Your Personalized Diet Chart</h4>
            <?php if ($dominant): ?>
                <div class="alert alert-info mb-3">You are primarily <strong><?=htmlspecialchars($dominant)?></strong> prakriti.</div>
                <p><strong>Diet Advice:</strong> <?=$advice[$dominant]?></p>
            <?php else: ?>
                <div class="alert alert-warning">Please complete the Prakriti Analysis to receive your diet chart.</div>
            <?php endif; ?>
        </div>
    </div>
